...
public class Mutex {
	...
	*	WAIT_OBJECT_0.  This is a success code, indicating that you have acquire the mutex.
	...
	*/
	...
	public void release() {
		...
		//wait a little, to allow another thread to grab this if they want
	...
	public static final int	WAIT_FAILED=-1;			//same as 0xFFFFFFFF
 	...
 	public final static int OBJECT_WAIT_TIMEOUT=16258;
